...
function pagoTarjeta() {
    ...
    const swalWithBootstrapButtons = Swal.mixin({
      ...
      swalWithBootstrapButtons.fire({
        ...
        text: "Se realizará el pago con tarjeta VISA",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
          swalWithBootstrapButtons.fire(
            'Pedido realizado!',
            'Comuníquese a nuestro whatsapp para coordinar entrega y confirmación de pago',
            'success'
          )
        } else if (
...
$('.contador').countdown('2022/09/1 10:00:00', function(event){
